<div class="newslettergate">
    ...
    <form class="newslettergate-form" method="POST">
        <input type="hidden" name="ng_action" value="newslettergate_check" />
        ...
        <input type="email" name="ng_email" value="<?php echo esc_attr( $email ); ?>" placeholder="<?php esc_attr_e( 'Enter Email to check', 'newslettergate' ); ?>" />
